...
if __name__ == "__main__":
    ...
    clearml_logger = ClearMLLogger(task_name="synaptic neuron model", project_name="Masterarbeit")
    clearml_logger.get_task().connect(config)
    model = SimpleFC(config["alpha"], config["beta"], num_steps=config["num_steps"]).to(device)
