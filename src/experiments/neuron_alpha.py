...
class SimpleFCNet(nn.Module):
    ...
    def forward(self, x):
        ...
        for step in range(self.num_steps):
            spk, syn_exc, syn_inh, mem = self.net(x[:, step])
            spk_rec.append(spk)
            mem_rec.append(mem)
...
config = {
    ...
    "neuron_model": NeuronModels.ALPHA,
...
if __name__ == "__main__":
    ...
    clearml_logger = ClearMLLogger(task_name="Alpha base fashion_mnist", project_name="Masterarbeit/Alpha")
